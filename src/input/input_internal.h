...
enum input_control_e
{
    ...
    //**************************
    INPUT_CONTROL_SET_RATE_VIDEO,
    INPUT_CONTROL_SET_STATE_VIDEO,
    INPUT_CONTROL_SYNC_VIDEO,
    INPUT_CONTROL_SET_RATE_AUDIO,
    INPUT_CONTROL_SET_STATE_AUDIO,
    INPUT_CONTROL_SYNC_AUDIO,
};
